...
rewrite_clj.node.forms.FormsNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4303__auto__,k37953,else__4304__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k37953,else__4304__auto__);
...
return (function (ret__4323__auto__,p__37958){
var vec__37959 = p__37958;
var k__4324__auto__ = cljs.core.nth.call(null,vec__37959,(0),null);
var v__4325__auto__ = cljs.core.nth.call(null,vec__37959,(1),null);
...
rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__37952){
var self__ = this;
var G__37952__$1 = this;
return (new cljs.core.RecordIter((0),G__37952__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this37954,other37955){
var self__ = this;
var this37954__$1 = this;
return (((!((other37955 == null)))) && ((this37954__$1.constructor === other37955.constructor)) && (cljs.core._EQ_.call(null,this37954__$1.children,other37955.children)) && (cljs.core._EQ_.call(null,this37954__$1.__extmap,other37955.__extmap)));
});
...
rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4308__auto__,k__4309__auto__,G__37952){
var self__ = this;
var this__4308__auto____$1 = this;
var pred__37962 = cljs.core.keyword_identical_QMARK_;
var expr__37963 = k__4309__auto__;
if(cljs.core.truth_(pred__37962.call(null,new cljs.core.Keyword(null,"children","children",-940561982),expr__37963))){
return (new rewrite_clj.node.forms.FormsNode(G__37952,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.forms.FormsNode(self__.children,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4309__auto__,G__37952),null));
}
});
...
rewrite_clj.node.forms.FormsNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4300__auto__,G__37952){
var self__ = this;
var this__4300__auto____$1 = this;
return (new rewrite_clj.node.forms.FormsNode(self__.children,G__37952,self__.__extmap,self__.__hash));
});
 ...
 */
rewrite_clj.node.forms.map__GT_FormsNode = (function rewrite_clj$node$forms$map__GT_FormsNode(G__37956){
var extmap__4340__auto__ = (function (){var G__37965 = cljs.core.dissoc.call(null,G__37956,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_.call(null,G__37956)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__37965);
} else {
return G__37965;
}
})();
return (new rewrite_clj.node.forms.FormsNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__37956),null,cljs.core.not_empty.call(null,extmap__4340__auto__),null));
});
...
//# sourceMappingURL=forms.js.map?rel=1575052411065
