...
return rewrite_clj.reader.read_repeatedly.call(null,reader,(function (p1__37993_SHARP_){
var _STAR_delimiter_STAR__orig_val__37994 = rewrite_clj.parser.core._STAR_delimiter_STAR_;
var _STAR_delimiter_STAR__temp_val__37995 = delimiter;
rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__temp_val__37995;

try{return rewrite_clj.parser.core.parse_next.call(null,p1__37993_SHARP_);
}finally {rewrite_clj.parser.core._STAR_delimiter_STAR_ = _STAR_delimiter_STAR__orig_val__37994;
}}));
});
rewrite_clj.parser.core.parse_printables = (function rewrite_clj$parser$core$parse_printables(var_args){
var args__4647__auto__ = [];
var len__4641__auto___38004 = arguments.length;
var i__4642__auto___38005 = (0);
while(true){
if((i__4642__auto___38005 < len__4641__auto___38004)){
args__4647__auto__.push((arguments[i__4642__auto___38005]));

var G__38006 = (i__4642__auto___38005 + (1));
i__4642__auto___38005 = G__38006;
continue;
} else {
}
break;
...
rewrite_clj.parser.core.parse_printables.cljs$core$IFn$_invoke$arity$variadic = (function (reader,node_tag,n,p__38000){
var vec__38001 = p__38000;
var ignore_QMARK_ = cljs.core.nth.call(null,vec__38001,(0),null);
...
/** @this {Function} */
rewrite_clj.parser.core.parse_printables.cljs$lang$applyTo = (function (seq37996){
var G__37997 = cljs.core.first.call(null,seq37996);
var seq37996__$1 = cljs.core.next.call(null,seq37996);
var G__37998 = cljs.core.first.call(null,seq37996__$1);
var seq37996__$2 = cljs.core.next.call(null,seq37996__$1);
var G__37999 = cljs.core.first.call(null,seq37996__$2);
var seq37996__$3 = cljs.core.next.call(null,seq37996__$2);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37997,G__37998,G__37999,seq37996__$3);
});
...
return cljs.core.cons.call(null,(function (){var G__38007 = rewrite_clj.reader.peek.call(null,reader);
switch (G__38007) {
case "(":
...
var G__38009 = cljs.tools.reader.reader_types.peek_char.call(null,reader);
if(cljs.core._EQ_.call(null,null,G__38009)){
return rewrite_clj.reader.throw_reader.call(null,reader,"Unexpected EOF.");
} else {
if(cljs.core._EQ_.call(null,"\"",G__38009)){
...
if(cljs.core._EQ_.call(null,"_",G__38009)){
...
//# sourceMappingURL=core.js.map?rel=1575052411237
