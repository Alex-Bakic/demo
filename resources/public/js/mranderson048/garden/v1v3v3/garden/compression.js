 ...
 */
mranderson048.garden.v1v3v3.garden.compression.token_fn = (function mranderson048$garden$v1v3v3$garden$compression$token_fn(p__34183){
var vec__34184 = p__34183;
var tag = cljs.core.nth.call(null,vec__34184,(0),null);
var re = cljs.core.nth.call(null,vec__34184,(1),null);
return ((function (vec__34184,tag,re){
return (function (s){
...
var len__4641__auto___34189 = arguments.length;
var i__4642__auto___34190 = (0);
while(true){
if((i__4642__auto___34190 < len__4641__auto___34189)){
args__4647__auto__.push((arguments[i__4642__auto___34190]));

var G__34191 = (i__4642__auto___34190 + (1));
i__4642__auto___34190 = G__34191;
continue;
} else {
}
break;
...
return p1__34187_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
/** @this {Function} */
mranderson048.garden.v1v3v3.garden.compression.tokenizer.cljs$lang$applyTo = (function (seq34188){
var self__4629__auto__ = this;
return self__4629__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq34188));
});
...
var map__34192 = temp__5718__auto__;
...
var tag = cljs.core.get.call(null,map__34192__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__34192__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__34192__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__34195 = cljs.core.subs.call(null,s1,size);
var G__34196 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s2),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__34194 = tag;
...
//# sourceMappingURL=compression.js.map?rel=1575052458524
