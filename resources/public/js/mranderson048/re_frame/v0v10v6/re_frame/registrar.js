...
mranderson048.re_frame.v0v10v6.re_frame.registrar.kind__GT_id__GT_handler = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return cljs.core.get.call(null,cljs.core.deref.call(null,mranderson048.re_frame.v0v10v6.re_frame.registrar.kind__GT_id__GT_handler),kind);
});

mranderson048.re_frame.v0v10v6.re_frame.registrar.get_handler.cljs$core$IFn$_invoke$arity$2 = (function (kind,id){
return cljs.core.get.call(null,cljs.core.get.call(null,cljs.core.deref.call(null,mranderson048.re_frame.v0v10v6.re_frame.registrar.kind__GT_id__GT_handler),kind),id);
});
...
var handler = mranderson048.re_frame.v0v10v6.re_frame.registrar.get_handler.call(null,kind,id);
...
mranderson048.re_frame.v0v10v6.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"error","error",-978969032),"re-frame: no",cljs.core.str.cljs$core$IFn$_invoke$arity$1(kind),"handler registered for:",id);
} else {
}
} else {
}
...
if(mranderson048.re_frame.v0v10v6.re_frame.interop.debug_enabled_QMARK_){
if(cljs.core.truth_(mranderson048.re_frame.v0v10v6.re_frame.registrar.get_handler.call(null,kind,id,false))){
mranderson048.re_frame.v0v10v6.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),"re-frame: overwriting",cljs.core.str.cljs$core$IFn$_invoke$arity$1(kind),"handler for:",id);
} else {
}
} else {
}

cljs.core.swap_BANG_.call(null,mranderson048.re_frame.v0v10v6.re_frame.registrar.kind__GT_id__GT_handler,cljs.core.assoc_in,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [kind,id], null),handler_fn);
...
return cljs.core.reset_BANG_.call(null,mranderson048.re_frame.v0v10v6.re_frame.registrar.kind__GT_id__GT_handler,cljs.core.PersistentArrayMap.EMPTY);
});

mranderson048.re_frame.v0v10v6.re_frame.registrar.clear_handlers.cljs$core$IFn$_invoke$arity$1 = (function (kind){
if(cljs.core.truth_(mranderson048.re_frame.v0v10v6.re_frame.registrar.kinds.call(null,kind))){
} else {
throw (new Error("Assert failed: (kinds kind)"));
}

return cljs.core.swap_BANG_.call(null,mranderson048.re_frame.v0v10v6.re_frame.registrar.kind__GT_id__GT_handler,cljs.core.dissoc,kind);
});
...
if(cljs.core.truth_(mranderson048.re_frame.v0v10v6.re_frame.registrar.get_handler.call(null,kind,id))){
return cljs.core.swap_BANG_.call(null,mranderson048.re_frame.v0v10v6.re_frame.registrar.kind__GT_id__GT_handler,cljs.core.update_in,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [kind], null),cljs.core.dissoc,id);
} else {
return mranderson048.re_frame.v0v10v6.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),"re-frame: can't clear",cljs.core.str.cljs$core$IFn$_invoke$arity$1(kind),"handler for",[cljs.core.str.cljs$core$IFn$_invoke$arity$1(id),". Handler not found."].join(''));
}
});
...
//# sourceMappingURL=registrar.js.map?rel=1575052414482
