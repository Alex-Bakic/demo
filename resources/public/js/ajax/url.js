...
ajax.url.key_value_pair_to_str = (function ajax$url$key_value_pair_to_str(p__62354){
var vec__62355 = p__62354;
var k = cljs.core.nth.call(null,vec__62355,(0),null);
var v = cljs.core.nth.call(null,vec__62355,(1),null);
...
var vec_key_encode = (function (){var G__62361 = (function (){var or__4047__auto__ = vec_strategy;
...
switch (G__62361__$1) {
case "java":
return ((function (G__62361,G__62361__$1){
return (function (k){
return null;
});
;})(G__62361,G__62361__$1))
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__62361__$1)].join('')));
...
ajax.url.param_to_key_value_pairs.cljs$core$IFn$_invoke$arity$3 = (function (vec_key_transform,prefix,p__62365){
var vec__62366 = p__62365;
var key = cljs.core.nth.call(null,vec__62366,(0),null);
var value = cljs.core.nth.call(null,vec__62366,(1),null);
...
return (function (p__62369){
var vec__62370 = p__62369;
var key = cljs.core.nth.call(null,vec__62370,(0),null);
var value = cljs.core.nth.call(null,vec__62370,(1),null);
...
return (function (prefix,p__62373){
var vec__62374 = p__62373;
var key = cljs.core.nth.call(null,vec__62374,(0),null);
var value = cljs.core.nth.call(null,vec__62374,(1),null);
...
ajax.url.url_request_format.cljs$core$IFn$_invoke$arity$1 = (function (p__62383){
var map__62384 = p__62383;
var map__62384__$1 = (((((!((map__62384 == null))))?(((((map__62384.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62384.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62384):map__62384);
var vec_strategy = cljs.core.get.call(null,map__62384__$1,new cljs.core.Keyword(null,"vec-strategy","vec-strategy",1843221372));
...
//# sourceMappingURL=url.js.map?rel=1575467343032
