...
var G__62968 = format;
var G__62968__$1 = (((G__62968 instanceof cljs.core.Keyword))?G__62968.fqn:null);
switch (G__62968__$1) {
case "transit":
return ajax.transit.transit_request_format.call(null,format_params);
...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__62972_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__62972_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__62973){
...
var handler = cljs.core.get.call(null,map__62974__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__62974__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__62974__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return ((function (h,e,map__62974,map__62974__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__62976){
var vec__62977 = p__62976;
var ok = cljs.core.nth.call(null,vec__62977,(0),null);
var result = cljs.core.nth.call(null,vec__62977,(1),null);
...
;})(h,e,map__62974,map__62974__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__62980){
var map__62981 = p__62980;
var map__62981__$1 = (((((!((map__62981 == null))))?(((((map__62981.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__62981.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__62981):map__62981);
var opts = map__62981__$1;
var method = cljs.core.get.call(null,map__62981__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__62981__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__62981__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__62981__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__62981__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
...
//# sourceMappingURL=easy.js.map?rel=1575467343905
