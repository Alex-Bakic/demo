...
var G__41354 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__41354;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__41355 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41355,ch);
...
if(("\\" === ch__$1)){
var ch_41356__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_41356__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_41356__$2);
} else {
}

var G__41357 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__41357;
continue;
}
}
...
var vec__41365 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41365,(0),null);
var start_column = cljs.core.nth.call(null,vec__41365,(1),null);
...
var G__41368 = cljs.core.conj_BANG_.call(null,a,form);
a = G__41368;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__41369 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__41370 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__41370;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__41369;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__41371 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41371,(0),null);
var start_column = cljs.core.nth.call(null,vec__41371,(1),null);
...
var vec__41374 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41374,(0),null);
var end_column = cljs.core.nth.call(null,vec__41374,(1),null);
...
var vec__41377 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41377,(0),null);
var start_column = cljs.core.nth.call(null,vec__41377,(1),null);
...
var vec__41380 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41380,(0),null);
var end_column = cljs.core.nth.call(null,vec__41380,(1),null);
...
var vec__41383 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41383,(0),null);
var start_column = cljs.core.nth.call(null,vec__41383,(1),null);
...
var vec__41386 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41386,(0),null);
var end_column = cljs.core.nth.call(null,vec__41386,(1),null);
...
var sb = (function (){var G__41389 = (new goog.string.StringBuffer());
G__41389.append(initch);
...
var G__41391 = (function (){var G__41390 = sb;
G__41390.append(ch);

return G__41390;
})();
var G__41392 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__41391;
ch = G__41392;
continue;
}
...
switch (G__41395) {
case "\\":
var G__41399 = (function (){var G__41396 = sb;
G__41396.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__41396;
})();
var G__41400 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41399;
ch = G__41400;
continue;
...
break;
default:
var G__41401 = (function (){var G__41397 = sb;
G__41397.append(ch);

return G__41397;
})();
var G__41402 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41401;
ch = G__41402;
continue;
...
var vec__41403 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41403,(0),null);
var end_column = cljs.core.nth.call(null,vec__41403,(1),null);
...
var vec__41406 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41406,(0),null);
var column = cljs.core.nth.call(null,vec__41406,(1),null);
...
var vec__41411 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41411,(0),null);
var column = cljs.core.nth.call(null,vec__41411,(1),null);
...
var vec__41416 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41416,(0),null);
var column = cljs.core.nth.call(null,vec__41416,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__41421 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41421,(0),null);
var start_column = cljs.core.nth.call(null,vec__41421,(1),null);
...
var vec__41424 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41424,(0),null);
var end_column = cljs.core.nth.call(null,vec__41424,(1),null);
...
var G__41427 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__41427,true,null,opts,pending_forms);
...
var G__41428 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__41428)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__41428)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__41428)){
...
var _STAR_suppress_read_STAR__orig_val__41429 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__41430 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__41430;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__41429;
}});
...
var G__41431 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__41431,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__41431,rdr,first_line);
...
var G__41435 = matched;
var G__41436 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__41435;
finished = G__41436;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__41437 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__41438 = (function (){var or__4047__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__41438;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__41437;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__41439 = cljs.tools.reader.arg_env;
var arg_env_temp_val__41440 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__41440;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__41441 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41441,"(");
...
var G__41442 = (i + (1));
var G__41443 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4047__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__41439;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__41444 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__41444);
...
var G__41445 = cljs.core.next.call(null,s__$1);
var G__41446 = ret;
s__$1 = G__41445;
r = G__41446;
continue;
...
var G__41447 = cljs.core.next.call(null,s);
var G__41448 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__41447;
key_vals = G__41448;
continue;
} else {
...
var gensym_env_orig_val__41452 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__41453 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__41453;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__41452;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__41454 = token;
var G__41454__$1 = (((G__41454 == null))?null:cljs.core.subs.call(null,G__41454,(1)));
var G__41454__$2 = (((G__41454__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41454__$1));
var G__41454__$3 = (((G__41454__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41454__$2));
var G__41454__$4 = (((G__41454__$3 == null))?null:cljs.core.symbol.call(null,G__41454__$3));
if((G__41454__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__41454__$4);
}
})():(function (){var G__41455 = token;
var G__41455__$1 = (((G__41455 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41455));
if((G__41455__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41455__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__41466,reader){
...
var opts = map__41467__$1;
var eof = cljs.core.get.call(null,map__41467__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4641__auto___41475 = arguments.length;
var i__4642__auto___41476 = (0);
while(true){
if((i__4642__auto___41476 < len__4641__auto___41475)){
args__4647__auto__.push((arguments[i__4642__auto___41476]));

var G__41477 = (i__4642__auto___41476 + (1));
i__4642__auto___41476 = G__41477;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq41473){
var G__41474 = cljs.core.first.call(null,seq41473);
var seq41473__$1 = cljs.core.next.call(null,seq41473);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__41474,seq41473__$1);
});


//# sourceMappingURL=reader.js.map?rel=1575465420624
