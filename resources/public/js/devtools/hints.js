...
}catch (e37968){var _e = e37968;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___37971 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___37971)){
var seen_errors_37972 = temp__5718__auto___37971;
if(cljs.core.truth_(seen_errors_37972.has(self))){
} else {
seen_errors_37972.add(self);

var temp__5720__auto___37973 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___37973)){
var sense_37974 = temp__5720__auto___37973;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_37974)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1575052463396
