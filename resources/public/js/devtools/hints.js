...
var map__53584 = top_item;
var map__53584__$1 = (((((!((map__53584 == null))))?(((((map__53584.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53584.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53584):map__53584);
var file = cljs.core.get.call(null,map__53584__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__53584__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__53584__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e53583){var _e = e53583;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___53586 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___53586)){
var seen_errors_53587 = temp__5718__auto___53586;
if(cljs.core.truth_(seen_errors_53587.has(self))){
} else {
seen_errors_53587.add(self);

var temp__5720__auto___53588 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___53588)){
var sense_53589 = temp__5720__auto___53588;
...
//# sourceMappingURL=hints.js.map?rel=1575465439399
