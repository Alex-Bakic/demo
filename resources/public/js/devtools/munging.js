...
var o37463 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37463["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37464 = temp__5718__auto____$1;
return (o37464["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__36393__auto__ = f;
return (o__36393__auto__["toString"]).call(o__36393__auto__);
} else {
return "";
}
...
try{var o__36393__auto___37467 = t;
(o__36393__auto___37467["cljs$lang$ctorPrWriter"]).call(o__36393__auto___37467,t,writer);
}catch (e37466){var __37468 = e37466;
}
...
var char_code = (function (){var o__36393__auto__ = (new String(char$));
return (o__36393__auto__["charCodeAt"]).call(o__36393__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__36393__auto__ = String;
return (o__36393__auto__["fromCharCode"]).call(o__36393__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__37469 = num_code;
switch (G__37469) {
case (1):
return (185);
...
var o__36393__auto__ = String;
return (o__36393__auto__["fromCharCode"]).call(o__36393__auto__,superscript_code);
});
/**
...
}catch (e37471){var _e__36400__auto__ = e37471;
return false;
}})())){
...
var vec__37472 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__37472,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o37475 = temp__5718__auto__;
var temp__5718__auto____$1 = (o37475["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o37476 = temp__5718__auto____$1;
return (o37476["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__37479){
var vec__37480 = p__37479;
var ns_detector = cljs.core.nth.call(null,vec__37480,(0),null);
...
var G__37486 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__37487 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__37486;
remaining_tokens = G__37487;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq37477){
var G__37478 = cljs.core.first.call(null,seq37477);
var seq37477__$1 = cljs.core.next.call(null,seq37477);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37478,seq37477__$1);
});
...
var vec__37491 = cljs.core.split_with.call(null,(function (p1__37490_SHARP_){
return cljs.core.not_EQ_.call(null,p1__37490_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__37491,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__37491,(1),null);
...
var vec__37494 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__37494,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__37494,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__37497 = cljs.core.rest.call(null,remaining_tokens);
var G__37498 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__37497;
name_tokens = G__37498;
continue;
} else {
...
var vec__37501 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__37501,(0),null);
var arity = cljs.core.nth.call(null,vec__37501,(1),null);
var vec__37504 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__37504,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__37504,(1),null);
var vec__37507 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__37507,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__37507,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__37507,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__37507,(3),null);
...
var vec__37513 = result;
var munged_ns = cljs.core.nth.call(null,vec__37513,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__37513,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__37513,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__37513,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__37513,(4),null);
var arity = cljs.core.nth.call(null,vec__37513,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__37517 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__37517,(0),null);
var args = cljs.core.nth.call(null,vec__37517,(1),null);
var vec__37520 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__37520,(0),null);
var name = cljs.core.nth.call(null,vec__37520,(1),null);
...
var G__37523 = (arity + (1));
var G__37524 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__37525){
var vec__37526 = p__37525;
var arity = cljs.core.nth.call(null,vec__37526,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__37526,(1),null);
...
return cljs.core.get.call(null,arities,p1__37529_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__37530_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___37537 = arguments.length;
var i__4642__auto___37538 = (0);
while(true){
if((i__4642__auto___37538 < len__4641__auto___37537)){
args__4647__auto__.push((arguments[i__4642__auto___37538]));

var G__37539 = (i__4642__auto___37538 + (1));
i__4642__auto___37538 = G__37539;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__37533){
var vec__37534 = p__37533;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__37534,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq37531){
var G__37532 = cljs.core.first.call(null,seq37531);
var seq37531__$1 = cljs.core.next.call(null,seq37531);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__37532,seq37531__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__37542__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__37542__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__37542__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__37542__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__37543 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__37543,(0),null);
var fn_name = cljs.core.nth.call(null,vec__37543,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__37543,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__37543,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__37543,(4),null);
var arity = cljs.core.nth.call(null,vec__37543,(5),null);
...
var o__36393__auto__ = f;
return (o__36393__auto__["getBasis"]).call(o__36393__auto__);
});
/**
...
}catch (e37547){var _e__36400__auto__ = e37547;
...
var G__37548 = (obj[cljs.core.first.call(null,path)]);
var G__37549 = cljs.core.rest.call(null,path);
obj = G__37548;
path = G__37549;
continue;
} else {
...
return (function (accum,p__37550){
var vec__37551 = p__37550;
var bit = cljs.core.nth.call(null,vec__37551,(0),null);
var protocol = cljs.core.nth.call(null,vec__37551,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__37554){
var vec__37555 = p__37554;
var ns = cljs.core.nth.call(null,vec__37555,(0),null);
var name = cljs.core.nth.call(null,vec__37555,(1),null);
var selector = cljs.core.nth.call(null,vec__37555,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__37560,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__37560,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__37560,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__37558_SHARP_){
return (obj[cljs.core.first.call(null,p1__37558_SHARP_)]);
});})(name,sorted_matches,vec__37560,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1575465415551
